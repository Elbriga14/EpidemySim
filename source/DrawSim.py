...
def drawAllPawns(index, population):
	...
	ax.scatter(healthyPawnsX, healthyPanwsY, 50, c_ltb, label= "healthy")
...
def drawSimStatistics(index, totalTime, totalPopulation, infectedValues, healthyValues):
	...
	graph.plot(infectedValues,color=c_ltltb, linestyle='-', label="infected")
	graph.plot(healthyValues, color= c_ltg, linestyle='-', label="healthy")
